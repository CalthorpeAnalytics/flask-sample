...
from geoeditor.models import TokenBlacklist


def add_token_to_database(encoded_token: str, identity_claim: str) -> None:
    """
...
def revoke_token(token_jti: str, user: int) -> None:
